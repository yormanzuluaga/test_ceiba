...
class ApiClient {
  ...
  Future<http.Response> post(
    ...
    final uri = Uri.parse('https://jsonplaceholder.typicode.com/$path').replace(queryParameters: queryParameters);
  ...
  Future<http.Response> put(
    ...
    final uri = Uri.parse('https://jsonplaceholder.typicode.com/$path');
